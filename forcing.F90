...
!BOC
   ...
   integer (int_kind) :: &
      ...
      tavg_SHUM,         &! tavg_id for SHUM from cpl
...
!-----------------------------------------------------------------------
   ...
   call define_tavg_field(tavg_SHUM,'SHUM',2,                 &
                          long_name='specific humidity',      &
                          units='kg/kg', grid_loc='2110',     &
                          coordinates='TLONG TLAT time')
...
!-----------------------------------------------------------------------
   ...
   do iblock = 1,nblocks_clinic
      ...
      call accumulate_tavg_field(SHUM(:,:,iblock), tavg_SHUM,iblock,1)
